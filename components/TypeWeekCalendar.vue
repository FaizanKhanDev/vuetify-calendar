              ...
              <v-row>
                <v-col cols="12">
                  <v-textarea
                    ...
                    auto-grow
                    rows="3"
                    label="Add event details (required)"
                  ></v-textarea>
                </v-col>
              </v-row>
...
export default {
  ...
  methods: {
    ...
    cancelDrag() {
      console.log("cancelDrag", JSON.stringify(this.createEvent));
      console.log("his.extendOriginal", JSON.stringify(this.extendOriginal));
      if (this.createEvent) {
